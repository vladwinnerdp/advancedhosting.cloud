...
<div id="dialog_video" class="dialog-video" title="<?php esc_html_e("Add Media","unlimited_elements")?>" data-title="<?php esc_html_e("Add Media","unlimited_elements")?>" style="display:none">
	
	<!-- Type chooser -->
		
	<div id="video_dialog_loader" class="video-dialog-loader loader_text" style="display:none;">
		<?php esc_html_e("Loading Item Data...","unlimited_elements")?>
	</div>
	...
	<div id="video_dialog_inner">
		...
		<div id="video-dialog-wrap" class="video_left">
			...
			<div id="video_block_youtube" class="video-select-block">
				...
				<div class="video-title">
					<?php esc_html_e("Enter Youtube ID or URL","unlimited_elements")?>:
				</div>
				...
				<?php esc_html_e("example","unlimited_elements")?>:  <?php echo GlobalsUC::YOUTUBE_EXAMPLE_ID?>
				</div>
			...
			<div id="video_block_vimeo" class="video-select-block" style="display:none;" >
				...
				<div class="video-title">
					<?php esc_html_e("Enter Vimeo ID or URL","unlimited_elements")?>:
				</div>
				...
				<div class="video_example">
					<?php esc_html_e("example","unlimited_elements")?>:  <?php echo GlobalsUC::VIMEO_EXAMPLE_ID?>
				</div>
			...
			<div id="video_block_html5" class="video-select-block" style="display:none;">
					...
					<div class="video-title">				
						...
						<?php esc_html_e("Video MP4 Url", "unlimited_elements")?>:
						<a id="dv_link_example_mp4" href="javascript:void(0)"  class="dv_link_change dv_put_example" data-targetid="dv_html5_url_mp4" data-example="http://vjs.zencdn.net/v/oceans.mp4"><?php esc_html_e("put example", "unlimited_elements")?></a>
					...
					<div class="video-title">								
						...
						<?php esc_html_e("Video WEBM Url", "unlimited_elements")?>:
						<a id="dv_link_example_webm" href="javascript:void(0)"  class="dv_link_change dv_put_example" data-targetid="dv_html5_url_webm" data-example="http://video-js.zencoder.com/oceans-clip.webm"><?php esc_html_e("put example", "unlimited_elements")?></a>
					
					</div>
					<input type="text" id="dv_html5_url_webm" value="" class="input-url-long"></input>
		
					<div class="video-title">
						<?php esc_html_e("Video OGV Url", "unlimited_elements")?>:
						<a id="dv_link_example_ogv" href="javascript:void(0)"  class="dv_link_change dv_put_example" data-targetid="dv_html5_url_ogv" data-example="http://video-js.zencoder.com/oceans-clip.ogv"><?php esc_html_e("put example", "unlimited_elements")?></a>
					</div>
			...
			<div id="video_block_wistia" class="video-select-block">
				...
				<div class="video-title">
					<?php esc_html_e("Enter Wistia ID","unlimited_elements")?>:
				</div>
				...
				<div class="video_example">
				<?php esc_html_e("example","unlimited_elements")?>:  <?php echo GlobalsUC::WISTIA_EXAMPLE_ID?>
				</div>
			...
			<div class="video_props video_props_left mtop_20" style="display:none;">
					...
					<div class="video-title">
						<?php esc_html_e("Preview Image Url","unlimited_elements")?>:
						
						<a id="dv_link_change_image" href="javascript:void(0)"  class="dv_link_change" data-dialogtitle="<?php esc_html_e("Select new preview image", "unlimited_elements")?>"><?php esc_html_e("change", "unlimited_elements")?></a>
					...
					<div class="video-title mtop_20">
						<?php esc_html_e("Thumb Image Url","unlimited_elements")?>:
						
						<a id="dv_link_change_thumb" href="javascript:void(0)" class="dv_link_change" data-dialogtitle="<?php esc_html_e("Select new thumb image", "unlimited_elements")?>"><?php esc_html_e("change", "unlimited_elements")?></a>
					</div>
		...
		<input id="dv_button_video_add" type="button" class="unite-button-primary video_props" value="<?php esc_html_e("Add Video", "unlimited_elements")?>" data-textadd="<?php esc_html_e("Add Video", "unlimited_elements")?>" data-textupdate="<?php esc_html_e("Update Video", "unlimited_elements")?>">		
