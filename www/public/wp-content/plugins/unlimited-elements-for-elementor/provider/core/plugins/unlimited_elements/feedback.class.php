	...
	public function print_deactivate_feedback_dialog() {
		...
		$deactivate_reasons = [
			'imported_all_templates_needed'  => [
				'title'             => __( "I don't need the plugin anymore", "unlimited_elements"),
				'input_placeholder' => "Do you mind telling us why you don't need the plugin anymore",
			],
			'couldnt_find_suitable_template' => [
				'title'             => __( 'I found a better plugin that has the same features', "unlimited_elements"),
				'input_placeholder' => __( 'Do you mind writing us the name of the diffrent plugin you intend to use?', "unlimited_elements"),
			],
			'didnt_like_templates'           => [
				'title'             => __( "It's a temporary deactivation", "unlimited_elements"),
				'input_placeholder' => 'Why are you temporarily deactivating the plugin?',
			],
			'couldnt_get_it_to_work'         => [
				'title'             => __( "I couldn't get the plugin to work", "unlimited_elements"),
				'input_placeholder' => 'Can you describe what problem you encountered?',
			],
			'couldnt_get_it_to_work'         => [
				'title'             => __( "I found to many bugs", "unlimited_elements"),
				'input_placeholder' => 'Please help us improve the plugin by writing us which bug you found',
			],
			
			'other'                          => [
				'title'             => __( 'Other', "unlimited_elements" ),
				'input_placeholder' => __( 'Please describe the reason you are deactivating the plugin', "unlimited_elements"),
			],
		];
